...
CUDA_VISIBLE_DEVICES=0 python lerobot/scripts/train.py \
  --dataset.repo_id=[lerobot_dataset_converted2,lerobot_dataset_converted] \
  --dataset.root=/home/vai/Desktop/yujin/shortcut-learning-in-grps/lerobot \
