...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 lerobot/scripts/train_multi_gpu.py \
  --dataset.repo_id=[xyg_10_10_0.0_0.0/v-1.000-1.000_num1,xyg_10_10_0.0_0.0/v-1.000-1.000_num5,xyg_10_10_45.0_45.0/v-1.000-1.000_num1,xyg_10_10_45.0_45.0/v-1.000-1.000_num5,xyg_10_10_315.0_315.0/v-1.000-1.000_num1,xyg_10_10_315.0_315.0/v-1.000-1.000_num5] \
  ...
  --policy.num_dynamic_feature=1 \
  --policy.use_dynamic_common_feature=false \
  --policy.use_language=true \
  --policy.load_pretrained_dynamic_model_path=/data1/local/shortcut-learning-in-grps/lerobot/outputs/train/2025-11-11/15-27-27_pretrain_dynamic_backbone_angle_from_0_to_315_classification/checkpoints/005000/checkpoint.pt \
  --use_action_avg=true \
  --window_size=5 \
  --steps=50000 \
  --save_freq=5000 \
  ...
  --job_name=Dynamic_DP_ex1_angle_from_0_45_315_use_language_frozen_dynamic_backbone_trained_classification
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 lerobot/scripts/train_multi_gpu.py \
  ...
  --wandb.disable_artifact=true \
  --wandb.entity=DynamicVLA \
  --job_name=Dynamic_DP_ex1_angle_from_0_45_315_use_language_frozen_dynamic_backbone_trained_contrastive
