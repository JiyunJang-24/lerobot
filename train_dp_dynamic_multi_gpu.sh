...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 lerobot/scripts/train_multi_gpu.py \
  ...
  --job_name=Dynamic_DP_ex1_angle_from_0_to_315_use_language_common_feature
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 lerobot/scripts/train_multi_gpu.py \
  ...
  --wandb.disable_artifact=true \
  --wandb.entity=DynamicVLA \
  --job_name=Dynamic_DP_ex1_angle_from_0_to_315_use_not_language_common_feature
  ...
  --wandb.disable_artifact=true \
  --wandb.entity=DynamicVLA \
  --job_name=Dynamic_DP_ex1_angle_from_0_45_315_use_language_common_feature
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 lerobot/scripts/train_multi_gpu.py \
  ...
  --wandb.disable_artifact=true \
  --wandb.entity=DynamicVLA \
  --job_name=Dynamic_DP_ex1_angle_from_0_45_315_use_not_language_common_feature